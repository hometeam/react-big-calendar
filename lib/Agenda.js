...
var Agenda = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      'div',
      { className: 'rbc-agenda-view', __self: this
      },
      _react2.default.createElement(
        'table',
        { ref: 'header', __self: this
        },
        _react2.default.createElement(
          'thead',
          {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'th',
              { className: 'rbc-header', ref: 'dateCol', __self: this
              },
              messages.date
            ),
            _react2.default.createElement(
              'th',
              { className: 'rbc-header', ref: 'timeCol', __self: this
              },
              messages.time
            ),
            _react2.default.createElement(
              'th',
              { className: 'rbc-header', __self: this
              },
              messages.event
            )
          )
      ...
      _react2.default.createElement(
        'div',
        { className: 'rbc-agenda-content', ref: 'content', __self: this
        },
        _react2.default.createElement(
          'table',
          {
  ...
  renderDay: function renderDay(day, events, dayKey) {
    ...
    return events.map(function (event, idx) {
      ...
      var first = idx === 0 ? _react2.default.createElement(
        'td',
        { rowSpan: events.length, className: 'rbc-agenda-date-cell', __self: _this2
        },
        DateComponent ? _react2.default.createElement(DateComponent, { day: day, label: dateLabel, __self: _this2
        }) : dateLabel
      ) : false;
      ...
      return _react2.default.createElement(
        'tr',
        { key: dayKey + '_' + idx, __self: _this2
        },
        first,
        _react2.default.createElement(
          'td',
          { className: 'rbc-agenda-time-cell', __self: _this2
          },
          _this2.timeRangeLabel(day, event)
        ),
        _react2.default.createElement(
          'td',
          { className: 'rbc-agenda-event-cell', __self: _this2
          },
          EventComponent ? _react2.default.createElement(EventComponent, { event: event, title: title, __self: _this2
          }) : title
        )
      );
    }, []);
  ...
  timeRangeLabel: function timeRangeLabel(day, event) {
    ...
    return _react2.default.createElement(
      'span',
      { className: labelClass.trim(), __self: this
      },
      TimeComponent ? _react2.default.createElement(TimeComponent, { event: event, label: label, __self: this
      }) : label
    );
  },
