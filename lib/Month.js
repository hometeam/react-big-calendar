...
var MonthView = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'rbc-row rbc-month-header', __self: this
        },
  ...
  _dates: function _dates(row) {
    ...
    var dateLink = this.props.dateLink;

    return row.map(function (day, colIdx) {
      var offRange = _dates3.default.month(day) !== _dates3.default.month(_this6.props.date);
      var dateNumber = _localizer2.default.format(day, _this6.props.dateFormat, _this6.props.culture);
      var dateNumberElement = dateLink ? _react2.default.createElement(
        'a',
        { href: '#', onClick: _this6._dateClick.bind(null, day), __self: _this6
        },
        dateNumber
      ) : dateNumber;
  ...
  _renderMeasureRows: function _renderMeasureRows(levels, row, idx) {
    ...
    return first ? _react2.default.createElement(
      'div',
      { className: 'rbc-row', __self: this
      },
      _react2.default.createElement(
        'div',
        { className: 'rbc-row-segment', style: (0, _eventLevels2.segStyle)(1, 7), __self: this
        },
        _react2.default.createElement(
          'div',
          { ref: function ref(r) {
              return _this8._measureEvent = r;
            }, className: (0, _classnames2.default)('rbc-event'), __self: this
          },
          _react2.default.createElement(
            'div',
            { className: 'rbc-event-content', __self: this
            },
            ' '
          )
        )
