  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      selecting && _react2.default.createElement(
        'div',
        { className: 'rbc-slot-selection', style: style, __self: this
        },
  ...
  renderEvents: function renderEvents() {
    ...
    return events.map(function (event, idx) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'rbc-event-label', __self: _this
          },
          label
        ),
        _react2.default.createElement(
          'div',
          { className: 'rbc-event-content', __self: _this
          },
          EventComponent ? _react2.default.createElement(EventComponent, { event: event, title: title, __self: _this
          }) : title
        )
      );
    });
